...
import com.example.a24a10357_liorzalta_task1.Model.RecordsList;
...
public class RecordsManager {
    ...
    private static volatile RecordsManager instance = null;
    ...
    private RecordsManager(Context context) {
    ...
    public static void init(Context context) {
        synchronized (RecordsManager.class) {
            if (instance == null) {
                instance = new RecordsManager(context);
